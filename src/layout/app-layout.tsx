...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'finance-manager', 'transaction-analyst', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'New Table Nzgos',
      path: '/new-table-nzgos',
      entity: 'new_table_nzgo',
      service: AccessServiceEnum.PROJECT,
      icon: FiDatabase,
    },
    {
      name: 'New Table Yxzms',
      path: '/new-table-yxzms',
