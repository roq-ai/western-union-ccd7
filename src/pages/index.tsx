  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Western Union - Your comprehensive solution for recording transactions, tracking sender and receiver details, and calculating daily and monthly profits and losses."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563013544-824ae1b704d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0cmFuc2FjdGlvbnN8ZW58MHx8fHwxNjk1Mzk3MzM2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Western Union - Your comprehensive solution for recording transactions, tracking sender and receiver details, and calculating daily and monthly profits and losses.`}
            </Text>
            <Box
